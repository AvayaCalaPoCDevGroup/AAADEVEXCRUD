...
//import service.HttpLocal.HttpTokenRequest;
import service.Http.HttpTokenRequest;
import service.Security.AES;
import service.Security.XSSPrevent;
...
public class LogInActions {
    ...
    public void register() throws IOException, ServletException {
    	...
    	System.out.println("e18aaeed-63d9-40d2-af92-6a8a51263dd8 -> " + new AES().encrypt("e18aaeed-63d9-40d2-af92-6a8a51263dd8"));
    	System.out.println("AAADEVEXCRUD -> " + new AES().encrypt("AAADEVEXCRUD"));
...
//						.LoiIn("Access Snap In");
    ...
    private static String decryptText(String cipherText) {
        ...
        try {
            ...
            System.out.println("LoginActions Decrypt -> " +decryptedText);
